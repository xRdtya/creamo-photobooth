            ...
            <div class="relative aspect-1/3 rounded-lg overflow-hidden h-full">
                ...
                <div class="absolute inset-0 z-10">
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2 top-[45.5%] w-[80%] overflow-hidden">
                        <img src="https://ywrswuyjuvgrnfmugxwm.supabase.co/storage/v1/object/public/{{ $photos[2] }}" class="w-full h-full object-cover">
                    </div>
                    <div class="absolute left-1/2 -translate-x-1/2 top-[64%] w-[80%] overflow-hidden">
                        <img src="https://ywrswuyjuvgrnfmugxwm.supabase.co/storage/v1/object/public/{{ $photos[3] }}" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
