    ...
    <div class="w-11/12 max-w-300 min-h-175 flex rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] bg-white/40 backdrop-blur-lg border border-white/50 overflow-hidden relative">
        ...
        <div class="w-full lg:w-1/2 flex justify-center items-center p-6 md:p-12 relative z-10">
            <div class="bg-white w-full max-w-125 rounded-[30px] shadow-2xl p-8 md:p-12">
                ...
                <h2 class="text-[32px] font-bold text-black mb-1">Sign Up</h2>
                <p class="text-gray-400 text-[13px] mb-8 font-medium">Your Social Compaigns</p>
                ...
                <form action="/signup" method="POST" class="w-full">
                    ...
                    <p class="text-[11px] text-gray-400 mb-5">Use 8 or more characters with a mix of letters, numbers & symbols.</p>

                    <!-- Repeat Password Input -->
                    <div class="mb-6">
                        <label for="password_confirmation" class="block mb-2 text-[13px] font-bold text-gray-800">Repeat Password</label>
                        <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#172b4d] focus:border-transparent outline-none transition-all text-sm text-gray-800" required>
                    </div>
                    ...
                    <div class="flex gap-4 mb-8">
                        <a href="/auth/google/redirect" class="flex-1 flex items-center justify-center py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-[12px] font-bold text-gray-800">Sign Up with Google</span>
                        </a>
                        <a href="/auth/apple/redirect" class="flex-1 flex items-center justify-center py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                            ...
                            <span class="text-[12px] font-bold text-gray-800">Sign Up with Apple</span>
                        </a>
                    </div>

                    <!-- Submit Button -->
                    <button id="submitBtn" type="submit" disabled
                        class="w-full text-white font-medium rounded-lg text-sm px-5 py-3 text-center transition-all shadow-md
                    ...
                    <p class="text-[12px] font-medium text-gray-400 mt-6 text-center">
                        Already have an account? <a href="/signin" class="font-bold text-[#0052cc] hover:underline">Sign In</a>
                    </p>
                </form>
            </div>
        </div>
